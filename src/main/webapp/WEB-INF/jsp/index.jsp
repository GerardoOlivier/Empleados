                        ...
                        <c:forEach var="empleado" items="${empleados}"> 
                            <tr>
                                ...
                                <td>
                                    ...
                                    <fmt:formatNumber type="currency" value="${empleado.salario}"/>
                                </td>
                                <td class="tex-center">
                                    <c:set var="urlEditar">
                                    ...
                                    <a href="${urlEditar}" class="btn btn-warning bt-sm me-3">Editar</a>
                                    <c:set var="urlEliminar">
                                        <c:url value="${application.contextPath}/eliminar">
                                            <c:param name="idEmpleado" value="${empleado.idEmpleado}"/>
                                        </c:url>
                                    </c:set>
                                    <a href="${urlEliminar}" class="btn btn-danger bt-sm me-3">Eliminar</a>
                                </td>
                            </tr>                        
                        </c:forEach >
